...
public class UserListService implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String pageSkip = "";
		if (key.equals("")) {
			pageSkip = PageIndex.pageList(nowpage, totpage, "/Admin?cmd=user_list&pages=user", addtag);
		} else {
			pageSkip = PageIndex.pageListHan(nowpage, totpage, "/Admin?cmd=user_list&pages=user", query, key);
		}
