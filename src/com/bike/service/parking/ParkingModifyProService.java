...
public class ParkingModifyProService implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		vo.setPark_code(request.getParameter("code"));
		...
		int row = dao.parkingModify(vo);

		request.setAttribute("row", row);
		RequestDispatcher rd = request.getRequestDispatcher("/Admin/parking_modify_pro.jsp");
